  ...
  return (
    <main className="min-h-screen p-10">
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto border border-red-500">
          <div className="flex flex-wrap w-full mb-20 border border-red-500">
          ...
          <div className="flex flex-wrap -m-4 border border-red-500">
            {/* Map here */}
